...
impl FractalRenderer {
    pub(crate) fn new(
        ...
        let shader = wgpu::include_wgsl!("../shaders/fractal.wgsl");
        ...
        let sampler = device.create_sampler(&wgpu::SamplerDescriptor {
            label: Some("FractalRenderer sampler"),
        ...
        let vertex_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            label: Some("FractalRenderer vertex buffer"),
        ...
        let time_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            label: Some("FractalRenderer u_Time"),
        ...
        let settings_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            ...
            contents: bytemuck::bytes_of(&fractal_settings),
            usage: wgpu::BufferUsages::UNIFORM | wgpu::BufferUsages::COPY_DST,
        });
                ...
                wgpu::BindGroupLayoutEntry {
                    ...
                    ty: wgpu::BindingType::Buffer {
                        ...
                        min_binding_size: wgpu::BufferSize::new(
                            std::mem::size_of::<FractalSettings>() as u64
                        ),
                    },
                    count: None,
                },
    ...
    pub(crate) fn update_settings(&self, queue: &wgpu::Queue, fractal_settings: &FractalSettings) {
        queue.write_buffer(
            &self.settings_buffer,
            0,
            bytemuck::bytes_of(fractal_settings),
        );
    }
